const data = {
	...
	"work": [
		...
		},
		{
			...
			date: "Jan 17, 2023",
			description:
				"I created this quiz center as a side project to try to get better at both designing and programming user interfaces. This quiz center is pretty simple, it contains a list of randomly selected questions that are multiple choice, and a few that are short answer responses. The program will then neatly package everything to a Discord embed to display what their score was.",
		},
	],
};
